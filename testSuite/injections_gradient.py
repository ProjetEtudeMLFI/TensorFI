...
def run_test(suppress_out=False):
    ...
    print "After initialization\tW: " + str(curr_W) + " b: " + str(
        curr_b) + " error: " + str(curr_error)
    ...
    curr_W, curr_b, curr_error = s.run([W, b, error], {x: x_train, y: y_train})
    print "No injections\tW: " + str(curr_W) + " b: " + str(
        curr_b) + " error: " + str(curr_error)
    ...
    print "Before injections\tW: " + str(curr_W) + " b: " + str(
        curr_b) + " error: " + str(curr_error)
    ...
    print "After injections\tW: " + str(curr_W) + " b: " + str(
        curr_b) + " error: " + str(curr_error)
