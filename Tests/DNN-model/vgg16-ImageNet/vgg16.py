...
vgg = vgg16(imgs, 'vgg16_weights.npz',
            sess)  # load the vgg16 model with pretrained weight

# original label of the injected class. Change this to the classes you want to inject
...
# index of the sample to be injected
