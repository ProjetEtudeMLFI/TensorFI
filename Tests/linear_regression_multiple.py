...
print("No faults: ", np.average(accuracies_ok), "+/-",
      np.std(accuracies_ok) / np.sqrt(num_trials))
print("Faults: ", np.average(accuracies_faulty), "+/-",
      np.std(accuracies_faulty) / np.sqrt(num_trials))
